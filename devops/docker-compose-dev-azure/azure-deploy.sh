...
resourcename="opensearchstats"  # lower case, only
resourcegroup="opensearchstats_rg"
...
# git clone https://github.com/apilogicserver/opensearchstats.git
# cd opensearchstats
...
az group create --name opensearchstats_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group opensearchstats_rg --sku S1 --is-linux
az container create --resource-group opensearchstats_rg --name opensearchstats --image apilogicserver/opensearchstats:latest --dns-name-label opensearchstats --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//opensearchstats.westus.azurecontainer.io:5656'
