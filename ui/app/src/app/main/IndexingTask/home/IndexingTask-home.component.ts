...
@Component({
  selector: 'IndexingTask-home',
  templateUrl: './IndexingTask-home.component.html',
  styleUrls: ['./IndexingTask-home.component.scss']
})
export class IndexingTaskHomeComponent implements AfterViewInit {
