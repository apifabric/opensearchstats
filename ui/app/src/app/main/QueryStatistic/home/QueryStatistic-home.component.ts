...
@Component({
  selector: 'QueryStatistic-home',
  templateUrl: './QueryStatistic-home.component.html',
  styleUrls: ['./QueryStatistic-home.component.scss']
})
export class QueryStatisticHomeComponent implements AfterViewInit {
