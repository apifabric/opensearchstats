...
@Component({
  selector: 'SearchResult-home',
  templateUrl: './SearchResult-home.component.html',
  styleUrls: ['./SearchResult-home.component.scss']
})
export class SearchResultHomeComponent implements AfterViewInit {
