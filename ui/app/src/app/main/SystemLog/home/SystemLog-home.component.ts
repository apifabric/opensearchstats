...
@Component({
  selector: 'SystemLog-home',
  templateUrl: './SystemLog-home.component.html',
  styleUrls: ['./SystemLog-home.component.scss']
})
export class SystemLogHomeComponent implements AfterViewInit {
