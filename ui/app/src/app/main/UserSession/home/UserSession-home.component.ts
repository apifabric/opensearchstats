...
@Component({
  selector: 'UserSession-home',
  templateUrl: './UserSession-home.component.html',
  styleUrls: ['./UserSession-home.component.scss']
})
export class UserSessionHomeComponent implements AfterViewInit {
